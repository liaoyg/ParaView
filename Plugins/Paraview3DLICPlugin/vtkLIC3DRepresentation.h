...
public:
	...
	*/
	...
	//***************************************************************************
	// Forwarded to vtkLIC3DMapper
	virtual void SetLICStepSize(double val);
	virtual void SetNumberOfForwardSteps(int);
	virtual void SetNumberOfBackwardSteps(int);
	virtual void SetGradientScale(double);
	virtual void SetIllumScale(double);
	virtual void SetFreqScale(double);
	virtual void SetVolumeStepScale(double);

	//***************************************************************************
	// Forwarded to vtkResampleToImage resampler.
	virtual void SetVolumeDimension(int, int, int);
